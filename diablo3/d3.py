...
while True:
    ...
    if checkWindow():
        for i in range(20):
            if detectPos("images/normal.png"):
                pressEnter()
            elif detectPos("images/ancient.png"):
                pressEnter()
                pass
            elif detectPos("images/primal.png"):
                exit()
        skipExecute("images/execute.png")

        # if detectPos("./diablo3/primal.png"):
        #     break
        # else:
